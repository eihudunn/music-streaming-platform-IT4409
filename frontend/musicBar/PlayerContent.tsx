...
import CurrentMusicInformation from './CurrentMusicInformation';
...
const PlayerContent: React.FC<PlayerContentProps> = ({ song, songUrl }) => {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 h-full">
      <CurrentMusicInformation song={song} />
      ...
      <ProgressionBar song={song} songUrl={songUrl} />
